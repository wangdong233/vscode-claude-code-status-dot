 ...
 *
 * v0.5.34 ANCHOR_C / __ccsdUserDialogSet — covers consent/refusal dialogs CC
...
function buildIIFE(resDir: string): string {
    ...
    const bodyLines = [
        ...
        // v0.5.34 SENTINEL — three independent OR sources for `pend`, mirroring
...
function injectFresh(extJs: string, src: string): void {
    ...
    if (bCount === 1) {
        ...
        const replB =
            ...
            // v0.5.34 FIX: the v0.2.5 premise "rename_tab carries sessionId" is FALSE
    ...
    // Anchor C (optional v0.5.34): wrap requestUserDialog's outgoing
