...
// v0.5.6: stamp bumped for Favorites Bug 1/2/3/4 fixes (forceRefresh + dynamic
...
check('IIFE.21c banner carries v0.5.6 stamp', /\/\*cc-status-dot-injected:v0.5.6:/.test(iife));
