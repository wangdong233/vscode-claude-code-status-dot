 ...
 *
 * v0.5.32 ANCHOR_C / __ccsdUserDialogSet — covers consent/refusal dialogs CC
...
function buildIIFE(resDir: string): string {
    ...
    const bodyLines = [
        ...
        // v0.5.32 SENTINEL — three independent OR sources for `pend`, mirroring
...
function injectFresh(extJs: string, src: string): void {
    ...
    // Anchor C (optional v0.5.32): wrap requestUserDialog's outgoing
